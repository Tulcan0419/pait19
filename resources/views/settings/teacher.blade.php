...
<head>
    ...
    <title>Configuración - Profesor - Tecnológico Traversari - ISTPET</title>
...
<body>
    ...
    <i class="fas fa-chalkboard-teacher"></i>
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li><a href="{{ route('profesor.dashboard') }}"><i class="fas fa-home"></i> <span>Inicio</span></a></li>
                    <li><a href="#"><i class="fas fa-book-open"></i> <span>Mis Clases</span></a></li>
                    <li><a href="#"><i class="fas fa-tasks"></i> <span>Asignar Tareas</span></a></li>
                    <li><a href="#"><i class="fas fa-chart-line"></i> <span>Calificar</span></a></li>
                    <li><a href="#"><i class="fas fa-calendar-alt"></i> <span>Mi Horario</span></a></li>
                    <li><a href="#"><i class="fas fa-bell"></i> <span>Publicar Anuncios</span></a></li>
                    <li><a href="#"><i class="fas fa-file-alt"></i> <span>Recursos Docentes</span></a></li>
                    <li><a href="{{ route('profesor.professional_practices.index') }}"><i class="fas fa-briefcase"></i> <span>Prácticas Preprofesionales</span></a></li>
                    <li><a href="{{ route('profesor.settings') }}" class="active"><i class="fas fa-cog"></i> <span>Configuración</span></a></li>
                </ul>
            </nav>
            <div class="sidebar-footer">
                <form id="logout-form" action="{{ route('profesor.logout') }}" method="POST" style="display: none;">
                    @csrf
                </form>
                ...
                <div class="user-profile">
                    <div class="profile-photo-container">
                        ...
                        <div class="profile-overlay">
                            <a href="{{ route('profesor.profile.photo') }}" class="change-photo-btn">
