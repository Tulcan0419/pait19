...
<head>
    ...
    <title>Login Administrador - Tecnológico Traversari - ISTPET</title>
    ...
    <div class="auth-container">
        <div class="auth-left">
            <div>
                ...
                <p>Panel de administración para la gestión integral de la plataforma institucional.</p>
        ...
        <div class="auth-right">
            <div class="auth-card">
                ...
                <h2 class="auth-title">Acceso Administrador</h2>
